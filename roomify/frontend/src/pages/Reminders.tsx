    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Set and track important reminders and deadlines.</p>
        </div>
        <button
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <button
            ...
            className={`p-2 rounded ${viewMode === 'calendar' ? 'bg-primary-100 text-primary-600' : 'text-gray-400 hover:text-gray-600'}`}
      ...
      {viewMode === 'calendar' && (
        <div className="card">
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Calendar view will be implemented with a proper calendar component.</p>
          </div>
        </div>
      )}
