...
import com.roomify.database.entities.NotificationStatus;
...
@Repository
public interface NotificationRepository extends JpaRepository<com.roomify.database.entities.Notification, String> {
